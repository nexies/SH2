...
public slots:
    ...
    //!
    void sendQuery(QueryRequest request);
...
protected slots:
    ...
    //! \param query - Текст запроса
    //!
    void onSendQuery(QueryRequest request);
...
//    void onQueryFinished(const QUuid & uuid, QueryResult res);
    ...
    void onQueryResult(QueryResult res);
...
signals:
    ...
    //! \param query - Текст запроса
    //!
    void sendQuerySignal(QueryRequest);
...
private:
    ...
    SqlQueryThread * _queryThread { nullptr };
};
